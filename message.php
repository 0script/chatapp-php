...
<head>
    ...
    <link rel="stylesheet" href="publics/css/chats.css">
    <link rel="stylesheet" href="publics/css/message.css">
    <!-- Fontawesome CDN -->
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="container">
        ...
        <div class="card mt-4">
            ...
            <form action="controllers/send.php" method = "POST" style = "display: inline-block">
